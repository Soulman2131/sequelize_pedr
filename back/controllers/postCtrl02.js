//
//On va rajouter le GET ALL du LIKES pour ensuite gérer le FRONT du LIKE
//On trouve le findAll du Likes dont le UserId = au id (voir leS variables workbench du LIKES). Et pour cela, il faut que je rajoute à la route AUTH-TOKEN du GET-ALL de POST
